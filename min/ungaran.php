<div align='center'>
<?php
  $json_string = file_get_contents("http://api.wunderground.com/api/4fcc4b5d8690278a/conditions/forecast/q/IA/ungaran.json");
...
// Tahun  
 ...
 //hari 
  ...
  echo"Perkiraan cuaca 3 hari kedepan di Ungaran
  <br>
  <br>
  ";
  echo " 
  Cuaca saat ini di Kota Semarang hari ${dino} ${day} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'>";

  echo " 
  Cuaca saat ini di Kota Semarang hari ${dino1} ${day1} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'>";
  
    echo " 
  Cuaca saat ini di Kota Semarang hari ${dino2} ${day2} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'>";
  
    echo " 
  Cuaca saat ini di Kota Semarang hari ${dino3} ${day3} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'>";
?>
</div>