<?php
  $json_string = file_get_contents("http://api.wunderground.com/api/4fcc4b5d8690278a/conditions/forecast/q/IA/smrg_g.json");
...
// Tahun  
 ...
 //hari 
  ...
  echo"Cuaca 3 Hari di Tembalang
  <br>
  <br>";
  echo " 
  Cuaca saat ini di Tembalang hari ${dino} ${day} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'><br>";
  
    echo " 
  Cuaca saat ini di Tembalang hari ${dino1} ${day1} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'><br>";
  
    echo " 
  Cuaca saat ini di Tembalang hari ${dino2} ${day2} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'><br>";
  
    echo " 
  Cuaca saat ini di Tembalang hari ${dino3} ${day3} ${month} ${year} jam ${jam} adalah ${weather}<br>
  dengan suhu sekitar ${f}<sup>o</sup> Fahrenheit dan ${c}<sup>o</sup> Celcius<br>
  <br><img src='http://icons.wxug.com/i/c/k/" . $icon . ".gif'><br>";
?>
</div>